...
A = AV(i);
a = sim('Lab_4');
plotData(a.sim_in,a.sim_out,'k',"Filter dolnoprzepustowy",'Sygnal wejsciowy','Sygnal wyjsciowy');
end
...
A = AV(i);
a = sim('Lab_4');
plotData(a.sim_in,a.sim_out,'k',"Filter gornoprzepustowy",'Sygnal wejsciowy','Sygnal wyjsciowy');
end
...
A = AV(i);
a = sim('Lab_4');
plotData(a.sim_in,a.sim_out,'k',"Filter psamoprzepustowy",'Sygnal wejsciowy','Sygnal wyjsciowy');
end
...
A = AV(i);
a = sim('Lab_4');
plotData(a.sim_in,a.sim_out,'k',"Filter drugiego rzedu",'Sygnal wejsciowy','Sygnal wyjsciowy');
end
...
a = sim('SumFilter');
plotDataTiled(a.sim_in,a.sim_out,'k',"Filter dolnoprzepustowy",'Sygnal wejsciowy','Sygnal wyjsciowy');

Numerator=[0.4 0]
Denominator=[0.4 1]

a = sim('SumFilter');
plotDataTiled(a.sim_in,a.sim_out,'k',"Filter gornoprzepustowy",'Sygnal wejsciowy','Sygnal wyjsciowy');
   
Numerator=[1 0]
Denominator=[1 2 1]

a = sim('SumFilter');
plotDataTiled(a.sim_in,a.sim_out,'k',"Filter pasmoprzepustowy",'Sygnal wejsciowy','Sygnal wyjsciowy');

Numerator=[0 1]
Denominator=[1 0.1 1]
a = sim('SumFilter');
plotDataTiled(a.sim_in,a.sim_out,'k',"Filter drugiego rzedu",'Sygnal wejsciowy','Sygnal wyjsciowy');
